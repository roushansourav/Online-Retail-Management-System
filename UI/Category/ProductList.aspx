<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/master.Master" CodeBehind="ProductList.aspx.cs" Inherits="UI.Category.ProductList" %>

<asp:Content runat="server" ContentPlaceHolderID="MainContent">
     <asp:ListView ID="productList" runat="server" DataKeyNames="Pid" GroupItemCount="4" ItemType="Model.Product">
         <EmptyDataTemplate>
             <table class="container-fluid table-responsive table" >
                 <tr>
         ...
         <ItemTemplate>
            <!-- <td runat="server">
             ...
             <td runat="server">
             <div class="table-responsive card stretched-link shadow-lg p-3 mb-5 bg-white rounded" style="width:300px; display:inline-grid;">
                    <a href="../Product/ProductPage.aspx?productID=<%#:Item.Pid%>">
                    ...
                    <p class="card-text"><b>Price: </b><%#:String.Format("{0:00}", Item.Pprice)%></p>
                    </a>
